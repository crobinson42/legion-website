...
<head>
  ...
  <title>William "Will" Preston / Sacramento Security Guard Manager - Legion Security</title>
    ...
    <section class="well well7">
      <div class="container">
        ...
        <p class="text-primary">
          <img src="/images/legion/will.jpg" width="300" style="float:left;margin:15px;"/>
          <div class="clearfloat"></div>

          <p class="">
            Sergeant William (Will) Preston is a U.S. Army veteran having served two tours as a Combat Infantryman to Iraq in support of Operation Iraqi Freedom.  Will has been awarded the Army Commendation Medal, Global War on Terrorism Expeditionary Medal, Global War on Terrorism Service Medal, National Defense Service Medal, Army Reserve Service Medal and Army Service Ribbon.  He has also earned the coveted Combat Infantryman’s Badge Insignia.
          </p>
          <br/>
          <p class="">
