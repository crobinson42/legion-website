    ...
    <section class="well well7">
      <div class="container">
        <h3 class="text-center">
          Justin Farnsworth<br/>
          Sergeant "Watch Commander"<br />
          Legion Security
        </h3>
